...
const email = ref('Joyce_McKenzie99@hotmail.com')
const password = ref('3k_xnqIcx7Vp1Gt')
...
<template>
    ...
    <div class="text-center mb-5">
        ...
        <a class="font-medium no-underline ml-2 text-blue-500 cursor-pointer">Crear una cuenta ahora!</a>
    </div>
